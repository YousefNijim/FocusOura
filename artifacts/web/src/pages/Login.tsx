    ...
    <div className="min-h-screen bg-[var(--color-background)] flex flex-col items-center justify-center px-4">
      <div className="w-full max-w-sm">
        <div className="text-center mb-8">
          ...
          <p className="text-[var(--color-text-secondary)] mt-1">Welcome back</p>
        </div>

        <div className="glass-card rounded-3xl p-6 shadow-lg">
          <h2 className="text-xl font-semibold text-[var(--color-text-primary)] mb-5">Sign In</h2>
          ...
          <div className="relative my-5">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-3 bg-white/80 text-[var(--color-text-muted)]">or</span>
            </div>
          </div>

          <button
            onClick={handleGoogleLogin}
            disabled={googleLoading || loading || firebaseAvailable === false}
            className="w-full py-3 rounded-2xl border border-[var(--color-border)] bg-white/80 text-[var(--color-text-primary)] font-medium flex items-center justify-center gap-3 hover:bg-white hover:shadow-sm active:scale-95 transition disabled:opacity-50 disabled:cursor-not-allowed"
          >
            {googleLoading ? (
